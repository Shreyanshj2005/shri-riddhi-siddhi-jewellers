...
export const Route = createFileRoute("/_site/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions | Shri Riddhi Siddhi Jewellers" },
      { name: "description", content: "Terms & Conditions for the Shri Riddhi Siddhi Jewellers website, Sultanpur." },
      { property: "og:title", content: "Terms & Conditions | Shri Riddhi Siddhi Jewellers" },
      { property: "og:description", content: "Terms & Conditions for the Shri Riddhi Siddhi Jewellers website." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <div className="container-luxe max-w-3xl py-16 lg:py-24">
      ...
      <h1 className="gold-rule mt-3 font-serif text-4xl sm:text-5xl">Terms & Conditions</h1>
